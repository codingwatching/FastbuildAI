 ...
 * Version: 25.0.5
 * Generated: 2025-12-04T02:01:48.068Z
 *
...
export class Migration1764813706127 implements MigrationInterface {
    name = "Migration1764813706127";

    public async up(queryRunner: QueryRunner): Promise<void> {
        // 删除已存在的表（按依赖顺序：先删除关联表，再删除主表）
        ...
        await queryRunner.query(
            `DROP TYPE IF EXISTS "public"."membership_plans_duration_config_enum" CASCADE`,
        );
        ...
        await queryRunner.query(`ALTER TABLE "permissions" DROP COLUMN "plugin_pack_name"`);
        await queryRunner.query(`ALTER TABLE "menus" DROP COLUMN "pluginPackName"`);
        await queryRunner.query(
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "menus" ADD "pluginPackName" character varying(50)`);
        await queryRunner.query(
