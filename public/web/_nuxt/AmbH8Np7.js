import{d as S,s as w,g as b,c as a,o as r,q as e,v as n,l as d,y as z,F as C,B as _,z as g,p as o,x as D,t as f,k as E}from"#entry";import{_ as L}from"./D_U-ZTzd.js";import{_ as I}from"./Bshy66Rp.js";import"./DdBswP62.js";import"./Btvd554H.js";import"./3UOIlTK8.js";import"./DuSMYVIA.js";import"./8trvJunN.js";import"./VGKgjfSv.js";import"./oFTPHjuc.js";import"./BcsO9TDZ.js";import"./DlAUqK2U.js";const H={class:"space-y-4"},M={class:"mb-2 text-lg font-medium"},T={class:"text-muted-foreground text-sm"},j={key:0,class:"border-border rounded-lg border p-6 text-center"},W={class:"mb-2 font-medium"},P={class:"text-muted-foreground text-sm"},R={key:1,class:"space-y-4"},A={class:"flex border-b"},N=["onClick"],U={class:"space-y-4"},V={key:0,class:"space-y-4"},J={class:"space-y-3"},K={class:"mb-1 font-medium"},q={class:"text-muted-foreground text-sm"},F={class:"flex flex-wrap gap-4"},G=["onClick"],Q={key:0,class:"bg-primary absolute top-2 right-2 z-10 flex size-5 items-center justify-center rounded-full"},Z={class:"w-full space-y-3"},ee={class:"flex items-center justify-between"},te={class:"font-medium"},ne={class:"bg-muted rounded-lg p-4 text-sm"},oe={class:"block whitespace-break-spaces"},ie={class:"text-muted-foreground text-xs"},se={key:1,class:"w-full space-y-3"},ae={class:"flex items-center justify-between"},re={class:"relative w-full"},de={class:"bg-muted max-h-96 w-full overflow-auto rounded-lg p-4 text-sm"},ce={class:"block whitespace-pre"},le={class:"text-muted-foreground text-xs"},pe={key:2,class:"w-full space-y-3"},ue={class:"flex items-center justify-between"},be={class:"font-medium"},fe={class:"relative w-full"},he={class:"bg-muted max-h-96 w-full overflow-auto rounded-lg p-4 text-sm"},ge={class:"block whitespace-pre"},me={class:"text-muted-foreground text-xs"},Se=S({__name:"embed-code",props:{agent:{}},setup(m){const x=m,l=w("iframe"),p=w("bottom-right"),s=b(()=>x.agent?.publishToken?`${window.location.origin}/public/agent/shared/${x.agent.publishToken}`:""),k=[{value:"fullscreen",label:"全屏嵌入",description:"智能体以全屏方式嵌入到页面中",icon:"bd:agent-embed-1"},{value:"bottom-right",label:"右下角悬浮",description:"右下角悬浮窗口，可收起和展开",icon:"bd:agent-embed-2"},{value:"right-middle",label:"右侧中部悬浮",description:"右侧中部悬浮窗口，可收起、展开和拖拽",icon:"bd:agent-embed-3"}],Y=t=>{if(!s.value)return"";const c="<!-- BuildingAI 智能体嵌入代码 -->";switch(t){case"fullscreen":return`${c}
<iframe
